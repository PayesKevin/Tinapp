...
class LoginThreePage extends StatelessWidget {
  ...
  CustomConfig({List<List<Color>> gradients, List<int> durations, List<double> heightPercentages, MaskFilter blur, Alignment gradientBegin, Alignment gradientEnd}) async {}
}

WaveWidget({config, int waveAmplitude, Size size}) async {
}